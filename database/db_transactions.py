...
def get_all_transactions():
     ...
     try:
        ...
        print(f"\033[91merror get_all_transactions: \n {e} \n \033[0m")
#########################################################
...
"""
     try:
        ...
        print(f"\033[91merror get_transactions_of_month: \n {e} \n \033[0m")
#########################################################
...
WHERE id = {id};"""
     try:
        ...
        print(f"\033[91merror approve_a_transactions: \n {e} \n \033[0m")
#########################################################
...
WHERE id = {id};"""
     try:
        ...
        print(f"\033[91merror update_amount_transactions: \n {e} \n \033[0m")
#########################################################
...
""" 
     try:
        ...
        print(f"\033[91merror add_transactions:  \n {e} \n \033[0m")
#########################################################
