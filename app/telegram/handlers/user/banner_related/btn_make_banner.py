...
def get_banner_title(msg: Message):
    ...
    with bot.retrieve_data(msg.from_user.id, msg.chat.id) as data:
        data['title'] = msg.text
    msg_to_delete=bot.send_message(msg.chat.id, get_message("banner.msg.name"),reply_markup=cancel_markup(),)
    schedule_message_deletion(chat_id=msg_to_delete.chat.id,message_id=msg_to_delete.id,delay=50)
#########################################################################
...
def get_banner_name(msg: Message):
    ...
    with bot.retrieve_data(msg.from_user.id, msg.chat.id) as data:
        data['name'] = msg.text
    msg_to_delete=bot.send_message(msg.chat.id, get_message("banner.msg.member"),reply_markup=cancel_markup(),)
    schedule_message_deletion(chat_id=msg_to_delete.chat.id,message_id=msg_to_delete.id,delay=50)
#########################################################################
...
def get_banner_member(msg: Message):
    ...
    msg_to_delete=bot.send_message(msg.chat.id, get_message("banner.msg.link"),reply_markup=cancel_markup(),)
    schedule_message_deletion(chat_id=msg_to_delete.chat.id,message_id=msg_to_delete.id,delay=50)
#########################################################################
